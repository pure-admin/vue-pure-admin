...
<template>
  <div>
    <el-card class="mb-5" shadow="never">
      ...
      <div v-ripple class="mb-5 text-center shadow-md rounded-md p-8 text-lg">
        HTML元素
      </div>
      <span v-ripple class="inline-block shadow-md rounded-md p-8 text-lg"
        >行内元素需要添加display: block或display: inline-block才能生效</span
      >
      <el-divider />
      <div class="mb-5">
      ...
      <div
        v-ripple.center
        class="mb-5 text-center shadow-md rounded-md p-8 text-lg"
      >
        始终从中心触发波纹
      </div>
      <el-divider />
      ...
      <div
        ...
        class="my-5 text-center shadow-md rounded-md p-4 text-lg"
      >
        自定义波纹颜色
      </div>
      <el-divider />
      ...
      <div>
        <el-card v-ripple style="width: 480px" shadow="hover">Card</el-card>
      </div>
    </el-card>
  </div>
</template>
